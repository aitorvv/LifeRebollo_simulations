...
# set directory
general_dir <- "/media/aitor/WDE/iuFOR_trabajo/Proyectos/Life_Rebollo/0_Entregable_C11/2_simanfor/4_septiembre_23/output/SG/"
setwd(general_dir)
...
df$n_scnr <- sub("LR_SG02_|\\.json", "", df$Nombre_archivo_escenario)
...
graph_1 <- 
  ...
  # text
  labs(title = "Densidad de la parcela SG02",  
       # subtitle = "",  
...
graph_1
ggsave(filename = '../../graphs/SG/N.png', device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)
...
graph_1 <- 
  ...
  # text
  labs(title = "Mortalidad natural de la parcela SG02",  
       # subtitle = "",  
       x = "Edad de la masa (años)",  
       y = "Densidad (pies/ha)"   
  ) +
...
# watch and save graph
graph_1
ggsave(filename = '../../graphs/SG/mortalidad.png', device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)
...
graph_1 <- 
  ...
  # text
  labs(title = "Masa incorporada de manera natural en la parcela SG02",  
       # subtitle = "",  
       x = "Edad de la masa (años)",  
       y = "Densidad (pies/ha)"   
  ) +
...
# watch and save graph
graph_1
ggsave(filename = '../../graphs/SG/masa_incorporada.png', device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)
...
graph_1 <-
  ...
  # text
  labs(title = "Área basimétrica de la parcela SG02",
       # subtitle = "",
       x = "Edad de la masa (años)",
...
# watch and save graph
graph_1
ggsave(filename = '../../graphs/SG/G.png', device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)
...
#   
#   # text
#   labs(title = "Volumen de madera extraída de la parcela SG02",
#        # subtitle = "",
#        x = "Edad de la masa (años)",
...
# # watch and save graph
# graph_1
# ggsave(filename = '../../graphs/SG/V_extraido.png', device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)
...
graph_1 <-
  ...
  # text
  labs(title = "Índice de Hart-Becking de la parcela SG02",
       # subtitle = "",
       x = "Edad de la masa (años)",
...
# watch and save graph
graph_1
ggsave(filename = '../../graphs/SG/Hart.png', device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)
...
# get scenario code
new_df$n_scnr <- sub("LR_SG02_|\\.json", "", new_df$Nombre_archivo_escenario)
...
graph_1 <-
  ...
  # text
  labs(title = "Biomasa total y carbono acumulado en la parcela SG02",
...
# watch and save graph
graph_1
ggsave(filename = '../../graphs/SG/wood/WT_C.png', device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)
...
graph_1 <-
  ...
  # text
  labs(title = "Volumen de madera total de la parcela SG02",
       subtitle = "incluye madera extraída en las cortas",
       x = "Edad de la masa (años)",
       y = "Volumen (m³/ha)"
  ) +
...
# watch and save graph
graph_1
ggsave(filename = '../../graphs/SG/wood/V_all.png', device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)
...
graph_2 <-
  ...
  # text
  labs(title = "Volumen de madera total destinada a sierra (Life Rebollo) en la parcela SG02",
       subtitle = "incluye madera extraída en las cortas",
       x = "Edad de la masa (años)",
       y = "Volumen (m³/ha)"
  ) +
...
# watch and save graph
graph_2
ggsave(filename = '../../graphs/SG/wood/SIERRA.png', device = 'png', units = 'mm', dpi = 300,
...
graph_2 <-
  ...
  # text
  labs(title = "Volumen de madera total destinada a sierra gruesa (Life Rebollo) en la parcela SG02",
       subtitle = "incluye madera extraída en las cortas",
       x = "Edad de la masa (años)",
       y = "Volumen (m³/ha)"
  ) +
...
# watch and save graph
graph_2
ggsave(filename = '../../graphs/SG/wood/SIERRA_GRUESA.png', device = 'png', units = 'mm', dpi = 300,
       width = 300, height = 300)
...
graph_2 <-
  ...
  # text
  labs(title = "Volumen de madera total destinada a duelas (Intona - Life Rebollo) en la parcela SG02",
       subtitle = "incluye madera extraída en las cortas",
       x = "Edad de la masa (años)",
       y = "Volumen (m³/ha)"
  ) +
...
# watch and save graph
graph_2
ggsave(filename = '../../graphs/SG/wood/DUELAS.png', device = 'png', units = 'mm', dpi = 300,
       width = 300, height = 300)
...
graph_2 <-
  ...
  # text
  labs(title = "Volumen de madera total destinada a duelas de fondo (Intona - Life Rebollo) en la parcela SG02",
       subtitle = "incluye madera extraída en las cortas",
       x = "Edad de la masa (años)",
       y = "Volumen (m³/ha)"
  ) +
...
# watch and save graph
graph_2
ggsave(filename = '../../graphs/SG/wood/DUELAS_FONDO.png', device = 'png', units = 'mm', dpi = 300,
       width = 300, height = 300)
...
graph_2 <-
  ...
  # text
  labs(title = "Volumen de madera total destinada a madera laminada (Gamiz - Life Rebollo) en la parcela SG02",
       subtitle = "incluye madera extraída en las cortas",
       x = "Edad de la masa (años)",
       y = "Volumen (m³/ha)"
  ) +
...
# watch and save graph
graph_2
ggsave(filename = '../../graphs/SG/wood/LAMINADA.png', device = 'png', units = 'mm', dpi = 300,
       width = 300, height = 300)
...
graph_2 <-
  ...
  # text
  labs(title = "Volumen de madera total destinada a usos múltiples (García Varona - Life Rebollo) en la parcela SG02",
       subtitle = "incluye madera extraída en las cortas",
       x = "Edad de la masa (años)",
       y = "Volumen (m³/ha)"
  ) +
...
# watch and save graph
graph_2
ggsave(filename = '../../graphs/SG/wood/VARIOS_GARCIA_VARONA.png', device = 'png', units = 'mm', dpi = 300,
       width = 300, height = 300)
