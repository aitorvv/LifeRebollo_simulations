...
# set directory
general_dir <- "/media/aitor/WDE/iuFOR_trabajo/Proyectos/Life_Rebollo/0_Entregable_C11/2_simanfor/4_septiembre_23/output/irregular/"
setwd(general_dir)
...
df$n_scnr <- sub("LR_irregular_|\\.json", "", df$Nombre_archivo_escenario)
df$n_scnr <- sub(".json", "", df$n_scnr)
df$n_scnr <- paste(toupper(substr(df$ID_Parcela, 1, 4)), df$n_scnr, sep = '_')

# delete empty rows
df <- df[!is.na(df$n_scnr), ]

# fill empty values
df$V_extraido <- ifelse(df$V_extraido == '' | is.na(df$V_extraido), 0, df$V_extraido)
...
graph_1 <- 
  ...
  # text
  labs(title = "Densidad de la parcela SO02 irregular",  
       # subtitle = "",  
...
graph_1
ggsave(filename = '../../graphs/irregular/SO02_mix/N.png', device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)
...
graph_1 <- 
  ...
  # text
  labs(title = "Mortalidad natural de la parcela SO02 irregular",  
       # subtitle = "",  
       x = "Edad de la masa (años)",  
       y = "Densidad (pies/ha)"   
  ) +
...
# watch and save graph
graph_1
ggsave(filename = '../../graphs/irregular/SO02_mix/mortalidad.png', device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)
...
graph_1 <- 
  ...
  # text
  labs(title = "Masa incorporada de manera natural en la parcela SO02 irregular",  
       # subtitle = "",  
       x = "Edad de la masa (años)",  
       y = "Densidad (pies/ha)"   
  ) +
...
# watch and save graph
graph_1
ggsave(filename = '../../graphs/irregular/SO02_mix/masa_incorporada.png', device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)
...
graph_1 <-
  ...
  # text
  labs(title = "Área basimétrica de la parcela SO02 irregular",
       # subtitle = "",
       x = "Edad de la masa (años)",
...
# watch and save graph
graph_1
ggsave(filename = '../../graphs/irregular/SO02_mix/G.png', device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)
...
#   
#   # text
#   labs(title = "Volumen de madera extraída de la parcela SO02 irregular",
#        # subtitle = "",
#        x = "Edad de la masa (años)",
...
# # watch and save graph
# graph_1
# ggsave(filename = '../../graphs/irregular/SO02_mix/V_extraido.png', device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)
...
graph_1 <-
  ...
  # text
  labs(title = "Índice de Hart-Becking de la parcela SO02 irregular",
       # subtitle = "",
       x = "Edad de la masa (años)",
...
# watch and save graph
graph_1
ggsave(filename = '../../graphs/irregular/SO02_mix/Hart.png', device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)



#### Graph results: SG02 ####

df <- df_copy[grepl('SG', df_copy$n_scnr), ]
...
graph_1 <- 
  ...
  # text
  labs(title = "Densidad de la parcela SG02 irregular",  
       # subtitle = "",  
       x = "Edad de la masa (años)",  
       y = "Densidad (pies/ha)"   
  ) +
...
# watch and save graph
graph_1
ggsave(filename = '../../graphs/irregular/SG02_mix/N.png', device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)
...
graph_1 <- 
  ...
  # text
  labs(title = "Mortalidad natural de la parcela SG02 irregular",  
       # subtitle = "",  
       x = "Edad de la masa (años)",  
       y = "Densidad (pies/ha)"   
  ) +
...
# watch and save graph
graph_1
ggsave(filename = '../../graphs/irregular/SG02_mix/mortalidad.png', device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)
...
graph_1 <- 
  ...
  # text
  labs(title = "Masa incorporada de manera natural en la parcela SG02 irregular",  
       # subtitle = "",  
       x = "Edad de la masa (años)",  
       y = "Densidad (pies/ha)"   
  ) +
...
# watch and save graph
graph_1
ggsave(filename = '../../graphs/irregular/SG02_mix/masa_incorporada.png', device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)
...
graph_1 <-
  ...
  # text
  labs(title = "Área basimétrica de la parcela SG02 irregular",
       # subtitle = "",
       x = "Edad de la masa (años)",
       y = "Área basimétrica (m²/ha)"
  ) +
...
# watch and save graph
graph_1
ggsave(filename = '../../graphs/irregular/SG02_mix/G.png', device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)
...
#   
#   # text
#   labs(title = "Volumen de madera extraída de la parcela SG02 irregular",
#        # subtitle = "",
#        x = "Edad de la masa (años)",
#        y = "Volumen extraído (m³/ha)"
#   ) +
...
# # watch and save graph
# graph_1
# ggsave(filename = '../../graphs/irregular/SG02_mix/V_extraido.png', device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)
...
graph_1 <-
  ...
  # text
  labs(title = "Índice de Hart-Becking de la parcela SG02 irregular",
       # subtitle = "",
       x = "Edad de la masa (años)",
       y = "Índice de Hart-Becking"
  ) +
